...
| `selfcal_scripts/lvf_params/` | Cached LVF params, `lvf_params_D{1..6}.npy`; generated by `drivers/precompute_lvf_params.py`. |
...
| `figures/` | Gitignored. Subdirs only: `benchmark/`, `cc_figure/`, `mosaics/`, `zodi_frames/`, `misc/` (catch-all for top-level renders). |
