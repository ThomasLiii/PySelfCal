...
CHUNK_BBOX = (0, 6363, 0, 6361)  # NW quadrant of D4 NEP
...
if __name__ == "__main__":
    ...
    FILE_SUFFIX = f'_damp0p1_reg0p1_applyWt_PAHfit_dampL5e-3_subch60_nosrcmask_NumCol5_full_NW_iter400_subchPoly3_w100_outThresh5_sigma2_polyK1'
    ...
    print(f"After NW center filter (bbox={CHUNK_BBOX}): "
