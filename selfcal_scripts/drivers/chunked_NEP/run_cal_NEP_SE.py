...
CHUNK_BBOX = (6313, 12676, 6311, 12672)  # SE quadrant of D4 NEP
...
if __name__ == "__main__":
    ...
    FILE_SUFFIX = f'_damp0p1_reg0p1_applyWt_PAHfit_dampL5e-3_subch60_nosrcmask_NumCol5_full_SE_iter400_subchPoly3_w100_outThresh5_sigma2_polyK1'
    ...
    print(f"After SE center filter (bbox={CHUNK_BBOX}): "
