...
if __name__ == "__main__":
    ...
    for job_name, channel_inputs in channel_jobs.items():
        ...
        cal_path = cc.save_calibration(cal_file=cal_file, overwrite=True)
        ...
        partial_make_offset_map = partial(make_spherex_stripped_offset_map,
                                    ...
                                    tot_subchannels=frame_setting['NumSubchannels']*frame_setting['NumChannels'], 
                                    num_columns=frame_setting['NumCol'])
        ...
        maps = mm.make_mosaic(
            ...
            chunk_map=detector_inputs['det_chunk_map'], 
            det_valid_mask=chunk_valid_mask[detector_inputs['det_chunk_map']], 
            max_workers=20,
        ...
        wav_mean, wav_std = wav_coadd(detector_inputs['det_BC'], detector_inputs['det_BW'], 
                                      ...
                                      sigma=mosaic_setting['Sigma'], batch_size=40, max_workers=40)    
