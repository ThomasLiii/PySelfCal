...
chunk_map = make_fiducial_chunk_map(detector, det_BC, num_subchannels=10, num_channels=17*2,
...
for ch in chs:
    ...
    mm.save_mosaic(mos_file=f'mosaic_det{detector}_ch{"-".join(map(str, ch))}_weighted.fits', overwrite=True)
